/* Progressive enhancement only — every page works fully without this file.
   No scroll-reveal (content is visible on load, per spec). The mobile nav is
   a CSS checkbox toggle; this only adds close-on-Escape / outside / link. */
(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    /* Inquiry form has no submission endpoint yet: block submit, show the note. */
